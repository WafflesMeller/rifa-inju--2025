...
export const TicketCard = ({ compra }) => {

  // Función auxiliar de fecha (puedes moverla a un archivo utils si prefieres)
  ...
  return (
    <div className="group relative bg-white rounded-3xl overflow-hidden shadow-2xl transform transition-all hover:-translate-y-1 hover:shadow-indigo-500/20">
      
      {/* Decoración superior tipo ticket */}
      <div className="h-2 bg-linear-to-r from-indigo-500 via-purple-500 to-pink-500" />

      <div className="p-6 sm:p-8">
        {/* Cabecera del Ticket: Cliente y Estado */}
        ...
        <div className="relative flex items-center justify-center my-6">
          {/* NOTA: Si cambias el fondo de tu página, cambia este bg-[#161a2c] por ese color */}
