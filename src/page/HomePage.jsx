...
import { Ticket, Zap, DollarSign } from 'lucide-react';

import PrizeCard from '../components/PrizeCard';
import StatCard from '../components/StatCounter';
...
const HomePage = ({ TICKET_PRICE, setActiveTab }) => {
  ...
  return (
    <div className="">
      {/* Banner Hero - STAT CARDS integradas y visibles */}
        ...
        >
          <div className="relative w-full overflow-hidden">
            ...
            <div className="relative z-10 w-full px-6 md:px-10 lg:px-16 py-16 md:py-24">
              <div className="mx-auto max-w-7xl flex flex-col items-center text-center gap-8 lg:flex-row lg:items-center lg:justify-between lg:text-left">
                {/* IZQ: texto y stats */}
                <div className="flex-1 max-w-2xl">
                  <div className="flex flex-col items-center lg:items-start">
                    ...
                    {/* --- Contadores integrados (pill counters) --- */}
                    <div className="w-full mt-8">
                      <div className="mx-auto max-w-4xl flex flex-col sm:flex-row items-center justify-center gap-4">
                        <StatCounter
                          ...
                          hint={`Faltan ${Math.max(0, total - sold)} boletos`}
                        />

                        <StatCounter
                          title="Fecha Sorteo"
                          value={<span className="whitespace-nowrap">31 Diciembre</span>}
                          icon={Zap}
                          color="bg-yellow-500"
